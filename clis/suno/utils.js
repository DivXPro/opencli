 ...
 * succeeds from a real Chrome tab, but the ToyCLI bridge's evaluate
...
import { ArgumentError, AuthRequiredError, CommandExecutionError, EmptyResultError, TimeoutError } from '@toy-box/opencli/errors';
